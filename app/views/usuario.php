    ...
    <section id="usuario" class="py-md-5 bg-sky">
        <div class="container bg-light p-5 py-5 h-100">
            ...
            <div class="alert alert-secondary">
                <h4 class="text-sm-center alert alert-dark rounded medium">Ultimas Tecnologias Pesquisadas:
                    <span class="badge badge-dark">
                        <?php
                        if (isset($_SESSION['historico'])) {
                            feedCards($_SESSION['historico']);
                        } else {
                            echo 0;
                        } ?>
                        / 6
                ...
                <div class="container-fluid historico">
                    <div class="row px-1 justify-content-around">
                        <div class="col-12">
                            <?php
                            if (isset($_SESSION['historico'])) {
                                cardsSalvos($_SESSION['historico']);
                            }
                            if (empty($_SESSION['historico'])) {
                                echo "<h2 class='text-center mt-1'>Sem Historico ainda</h2>";
                            }
